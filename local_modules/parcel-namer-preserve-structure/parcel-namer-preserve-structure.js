// Heavily inspired by https://github.com/mischnic/parcel-namer-preserve-structure.git
...
module.exports = (new Namer({
  name({ bundle, bundleGraph, options }) {
    ...
    //      `index.css`.
    // "bundle" instead of "mainBundle" fixes naming on CSS
    let name = nameFromContent(bundle, options.entryRoot);
    if (!bundle.isEntry) {
